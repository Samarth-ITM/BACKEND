...
- **Render:** [https://samarth-assignment-5-real-time-tic-tac-toe-game.onrender.com](https://samarth-assignment-5-real-time-tic-tac-toe-game.onrender.com)
- **Vercel:** [https://samarth-assignment-5-real-time-tic-tac-toe-game.vercel.app](https://samarth-assignment-5-real-time-tic-tac-toe-game.vercel.app)
...
Ensure MongoDB is installed and running locally on port `27017` or use a remote MongoDB Atlas URI.

To start local MongoDB service (e.g. with brew):
...
Create or verify `.env` inside `Samarth_Navale_150096725148/`:
